                      ...
                      <form action="/produk/insert-stok-produk" method="POST" class="row g-3">
                        ...
                        <label for="inputHarga-jual1" class="form-label">Nama Produk</label>
                          <select class="form-select @error('id_nama_produk') is-invalid @enderror" name="id_nama_produk" aria-label="Default select example">
                            <option value="{{$data->id_barang}}" selected>{{$data->nama_produk->nama_produk}}</option>
                          </select>
                        ...
                        <div class="col-md-8">
                          ...
                          <input type="number" name="jumlah_stok" value="{{-$data->jumlah_barang}}" placeholder="Masukan Jumlah Stok Produk " class="form-control @error('jumlah_stok') is-invalid @enderror" id="inputName5">
                          @error('jumlah_stok')
                            <span class="invalid-feedback d-block">{{$message}}</span>
                          @enderror
                        </div>
                        <div class="col-md-4">
                          ...
                          <input type="date" name="tanggal" value="{{$data->tanggal}}" class="form-control @error('tanggal') is-invalid @enderror" id="inputDate1">
                          @error('tanggal')
                            <span class="invalid-feedback d-block">{{$message}}</span>
                          @enderror
                        </div>
